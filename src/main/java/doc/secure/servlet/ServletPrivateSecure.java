...
@Properties({ @Property(name = "service.description", value = "Prefix Test Servlet Minus One"),
		...
		@Property(name = "sling.servlet.paths", value = { "/service/secure/securedPrivate" }),
...
public class ServletPrivateSecure extends SlingAllMethodsServlet {

	
	/**
	 * it is used for private, and it is return document url as a private.
	 *  
	 *  **/
	    						  ...
	    						  if( jsonValid ){
	    							   ...
	    							   if( responseObj!=null && responseObj.length()!=0 ){
                                           ...
                                           if( responseObj.has("accesstype") && !getDocumentScriptData.isNullString(responseObj.getString("accesstype")) ){
                                        	   ...
                                        	   if( "private".equalsIgnoreCase(responseObj.getString("accesstype")) ){
