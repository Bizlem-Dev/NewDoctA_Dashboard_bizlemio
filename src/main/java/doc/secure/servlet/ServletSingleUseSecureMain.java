...
@Properties({ @Property(name = "service.description", value = "Prefix Test Servlet Minus One"),
		...
		@Property(name = "sling.servlet.paths", value = { "/service/secure/one" }),
...
public class ServletSingleUseSecureMain extends SlingAllMethodsServlet {

	/** 
	 * it is dispaly the esp page for one time or singleuse.
	 * 
	 * 
	 * **/
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		response.setContentType("text/plain");
	  		...
	  		try {
	  			...
	  			RequestDispatcher dis= request.getRequestDispatcher("/content/static/.PdfJsSingleuse");
