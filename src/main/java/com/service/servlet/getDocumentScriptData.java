...
@SlingServlet(paths = "/getDocumentScriptData")

public class getDocumentScriptData extends SlingAllMethodsServlet {
													...
													if (responseStrObj.length() != 0 && responseStrObj != null) {
														...
														if (status.equals("notOpen")) {
															...
															if (status.equals("open")) {
																...
																//rep.getWriter().println("openarray.length: "+docArrayObj.length());
...
//						propObj.put("noOfViewsDocument", noOfViews);
	...
	public static String getMailTrackResponse(String POST_PARAMS) {
		...
		try {
			...
			URL obj = new URL("http://bizlem.io:8087/apirest/doctojpeg/postprevmailTrackApi");
	...
	public static String getDocumentTrackResponse(String POST_PARAMS) {
		...
		try {
			...
			URL obj = new URL("http://bizlem.io:8087/apirest/doctojpeg/postpdfprevTrackApi");
			HttpURLConnection postConnection = (HttpURLConnection) obj.openConnection();
			postConnection.setRequestMethod("POST");
			postConnection.setRequestProperty("Content-Type", "application/json");
			postConnection.setDoOutput(true);
	...
	public static String getRemainingDocumentTimeResponse(String POST_PARAMS) {
		...
		try {
			URL obj = new URL("http://bizlem.io:8087/apirest/doctojpeg/pretimepdfTrackApi");
			HttpURLConnection postConnection = (HttpURLConnection) obj.openConnection();
			postConnection.setRequestMethod("POST");
			postConnection.setRequestProperty("Content-Type", "application/json");
			postConnection.setDoOutput(true);
	...
	public static String getRemainingMailTimeResponse(String POST_PARAMS) {
		StringBuffer response = null;
		try {
			URL obj = new URL("http://bizlem.io:8087/apirest/doctojpeg/pretimevmailTrackApi");
			HttpURLConnection postConnection = (HttpURLConnection) obj.openConnection();
			postConnection.setRequestMethod("POST");
			postConnection.setRequestProperty("Content-Type", "application/json");
			postConnection.setDoOutput(true);
