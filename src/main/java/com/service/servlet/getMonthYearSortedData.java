...
@SlingServlet(paths = "/getMonthYearSortedData")

public class getMonthYearSortedData extends SlingAllMethodsServlet {
...
//											}
											 ...
											 SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");	
											   Date endDate = formatter.parse(GenerationDate);
												...
												//Create 2 instances of Calendar
												   ...
												   cal2.setTime(new Date()); // currentdate
